      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start space-x-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">{channel.description}</p>
          </div>
        </div>

        {/* Configuration Fields */}
        <div>
          <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Channel Settings</h4>
          {renderConfigFields()}
        </div>
